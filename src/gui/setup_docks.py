...
from src.utils.classes import OutputStream
from src.utils.io import FileIO
from src.gui.windows.left_dock_window import LeftDockWindow
from src.gui.windows.central_dock_window import CentralDockWindow
...
class SetupDocks(QMainWindow):
    ...
    def create_ToolBar(self) -> None:
        ...
        folder: str = os.path.join(script_dir, "..", "..", "assets", "icons", "analysis_window")
        ...
        for icon_path, text, tooltip, icon_size, icon_function in actions:
            add_toolbar_action(toolBar, os.path.join(folder,icon_path), text, tooltip, icon_size, icon_function)
    ...
    def create_left_dock(self) -> None:
        ...
        self.addDockWidget(Qt.DockWidgetArea.LeftDockWidgetArea, LeftDockWindow.boundary_dock)
        self.addDockWidget(Qt.DockWidgetArea.LeftDockWidgetArea, LeftDockWindow.details_dock)
        self.resizeDocks([LeftDockWindow.boundary_dock], [350], Qt.Orientation.Horizontal)
