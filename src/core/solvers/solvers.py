...
from src.core.solvers.direct import DirectSolver
from src.core.solvers.iterative import IterativeSolver
from src.core.structure_io import DistributedLoadConverter
from src.core.elements.bar import LinearBarElement
from src.core.elements.beam import LinearBeamElement
from src.core.elements.frame import LinearFrameElement
from src.utils.units import UnitsHandling
from src.gui.viewers.report import ReportViewer
...
class MainSolver:
    ...
    def solve(self) -> Tuple[Dict, Dict]:
        ...
        report_viewer: ReportViewer = ReportViewer(solution, self.imported_data, theme)
