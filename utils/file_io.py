...
from utils.utils_classes import ScrollableMessageBox
...
# ---------------------------------------------
    ...
    def validate_input_file(lines: List[str]) -> Tuple[bool, List[str]]:
        ...
        """
        structure_types_data = FileIO.read_json('../data/structure_types.json')
        ...
        required_sections: List[str] = [
            ...
            "NODES_DISPLACEMENT_START", "NODES_DISPLACEMENT_END",
            "NODES_CONCENTRATED_LOADS_START", "NODES_CONCENTRATED_LOADS_END",
            "ELEMENTS_DISTRIBUTED_LOADS_START", "ELEMENTS_DISTRIBUTED_LOADS_END",
        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                if (
                    ...
                    file_content_html = file_viewer.generate_input_file_report(loaded_data)
