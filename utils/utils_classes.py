...
class SilentWebEnginePage(QWebEnginePage):
    ...
    messages containing "willReadFrequently", which can often be noisy and
    ...
    def javaScriptConsoleMessage(self, level: 'QWebEnginePage.JavaScriptConsoleMessageLevel', 
        ...
        If the message contains "willReadFrequently", it is ignored. Otherwise,
        the message is passed to the base class implementation for default handling.
        Args:
