...
class ReportViewer(QMainWindow):
    ...
    def __init__(self, solution_data: Dict[str, Any], imported_data: Dict[str, Any]):
        """
    ...
    def get_css_styles(self, font_scale: float = 0.8) -> str:
        """
        Helper Method: Returns the CSS styles for the HTML report.
        Allows for scaling of font sizes.
        Args:
    ...
    def get_solution_status_badge(self) -> str:
        """
        Helper Method: Determines the CSS class for the solution status badge
    ...
    def format_value(self, val: Any) -> str:
        """
        Helper Method: Formats a numeric value for display in the HTML tables.
    ...
    def generate_displacement_plot(self) -> str:
        """
        Helper Method: Generates a Matplotlib plot of nodal displacements.
    ...
    def generate_force_plot(self) -> str:
        """
        Helper Method: Generates a Matplotlib plot of nodal forces.
        The plot is saved as a PNG image in a BytesIO buffer and then
        base64 encoded for embedding directly into the HTML report.
        Returns:
    ...
    def generate_element_plot(self) -> str:
        """
        Helper Method: Generates a Matplotlib plot of element internal forces and moments.
    ...
    def format_nodes_table(self) -> str:
        """
        Helper Method: Formats the nodal displacements and forces into an HTML table.
    ...
    def format_elements_table(self) -> str:
        """
        Helper Method: Formats the element internal forces and moments into an HTML table.
    ...
    def format_summary_table(self) -> str:
        """
        Helper Method: Formats the analysis summary information into an HTML table.
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{'Yes' if solver_info.get('is_valid', False) else 'No'}</td>
                </tr>
            </tbody>
        </table>
        """
    ...
    def format_material_properties(self) -> str:
        """
        Helper Method: Formats the properties of the first detected material
    ...
    def format_cross_section_properties(self) -> str:
        """
        Helper Method: Formats the properties of the first detected cross-section
