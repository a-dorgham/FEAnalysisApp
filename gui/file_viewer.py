...
class FileViewer:
    ...
    def generate_input_file_report(self, imported_data: Dict[str, Any]) -> str:
        """
        ...
        html: str = self.generate_final_html(structure_info, html_content)
        return html
    ...
    def format_value(val: Any) -> str:
        """
        Static Method: Formats a given value for display in the HTML report.
    ...
    def create_key_value(self, key: str, value: Any) -> str:
        """
        Helper Method: Creates an HTML string for a key-value pair, formatted
    ...
    def create_section(title: str, content: str) -> str:
        """
        Static Method: Creates an HTML section block with a title and its content.
        Args:
    ...
    def create_table_from_dict(self, data: Dict[str, Any], title: Optional[str] = None) -> str:
        """
        Helper Method: Generates an HTML table from a dictionary, handling nested dictionaries
    ...
    @staticmethod
    def get_css_style(font_scale: float = 0.8) -> str:
        """
        Static Method: Returns a comprehensive CSS style string for the HTML report,
        with configurable font scaling.
        Args:
    ...
    def generate_final_html(self, structure_info: Dict[str, Any], body_content: str) -> str:
        report_date = datetime.now().strftime("%B %d, %Y at %H:%M:%S")
        css = self.get_css_style()
        html = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
    ...
    def create_nodes_table(self, nodes: Dict[str, Any], imported_data: Dict[str, Any]) -> str:
        """
        Helper Method: Generates an HTML table displaying information about all nodes
    ...
    def create_elements_table(self, elements: Dict[str, Any], imported_data: Dict[str, Any]) -> str:
        """
        Helper Method: Generates an HTML table displaying information about all elements
    ...
    def create_materials_table(self, materials: Dict[str, Any], units: Dict[str, str]) -> str:
        """
        Helper Method: Creates a single comprehensive HTML table summarizing properties
    ...
    def create_concentrated_loads_table(self, concentrated_loads: Dict[str, List[float]], force_labels: List[str], units: Dict[str, str]) -> str:
        """
        Helper Method: Creates an HTML table displaying concentrated loads applied
    ...
    def create_distributed_loads_table(self, distributed_loads: Dict[str, Any], units: Dict[str, str]) -> str:
        """
        Helper Method: Creates an HTML table displaying distributed loads applied
    ...
    def create_cross_section_visualization(section_type: str, dimensions: Dict[str, Any]) -> str:
        """
        Static Method: Generates an SVG visualization of a cross-section based on its
